    ...
    public class LoginClass : ILoginRepository
    {
        ...
        public async Task<ServiceResponse> RefreshTokenAsync(string refreshToken)
        {
            try
            {
                ...
                return new ServiceResponse("Refresh token functionality not implemented yet");
            }
            catch (Exception ex)
            {
                return new ServiceResponse(ex.Message);
        ...
        public async Task<ServiceResponse> ResetPasswordAsync(string email)
        {
            try
            {
                ...
                return new ServiceResponse("Password reset email sent");
            }
            catch (Exception ex)
            {
                return new ServiceResponse(ex.Message);
        ...
        public async Task<ServiceResponse> ConfirmPasswordResetAsync(string token, string newPassword)
        {
            try
            {
                ...
                return new ServiceResponse("Password reset confirmed");
            }
            catch (Exception ex)
            {
                return new ServiceResponse(ex.Message);
        ...
        public async Task<ServiceResponse> VerifyEmailAsync(string token)
        {
            try
            {
                ...
                return new ServiceResponse("Email verified successfully");
            }
            catch (Exception ex)
            {
                return new ServiceResponse(ex.Message);
        ...
        public async Task<ServiceResponse> ResendVerificationEmailAsync(string email)
        {
            try
            {
                ...
                return new ServiceResponse("Verification email sent");
            }
            catch (Exception ex)
            {
                return new ServiceResponse(ex.Message);
